...
PairStyle(hooke/cap,PairHookeCap)

#else

#ifndef LMP_PAIR_HOOKE_CAP_H
#define LMP_PAIR_HOOKE_CAP_H
#include <string>
#include <vector>
#include "pair.h"
...
class PairHookeCap : public Pair {
 public:
  PairHookeCap(class LAMMPS *);
  virtual ~PairHookeCap();
