...
PairStyle(hooke/cap/init,PairHookeCapInit)

#else

#ifndef LMP_PAIR_HOOKE_CAP_INIT_H
#define LMP_PAIR_HOOKE_CAP_INIT_H
#include <string>
#include <vector>
#include "pair.h"
...
class PairHookeCapInit : public Pair {
 public:
  PairHookeCapInit(class LAMMPS *);
  virtual ~PairHookeCapInit();
 ...
 protected:
  ...
  //------CAPILLARY FORCES--------//
  double maxSeparationDistanceRatio;
  double minSeparationDistanceRatio;
  std::vector<double> surfaceLiquidContentInitial;
  double surfaceTension;
  double fluidViscosity;
  double contactAngle;
  std::string SaturationFile;
  //------------------------------//
