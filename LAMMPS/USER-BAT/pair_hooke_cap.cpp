...
PairHookeCap::PairHookeCap(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 1;
...
void PairHookeCap::compute(int eflag, int vflag)
{
...
void PairHookeCap::settings(int narg, char **arg)
{
...
void PairHookeCap::coeff(int narg, char **arg)
{
...
void PairHookeCap::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairHookeCap::init_one(int i, int j)
{
  if (!allocated) allocate();
...
void PairHookeCap::write_restart(FILE *fp)
{
...
void PairHookeCap::read_restart(FILE *fp)
{
...
void PairHookeCap::write_restart_settings(FILE *fp)
{
...
void PairHookeCap::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairHookeCap::single(int i, int j, int itype, int jtype,
                                    double rsq,
...
int PairHookeCap::pack_forward_comm(int n, int *list, double *buf,
...
void PairHookeCap::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
double PairHookeCap::memory_usage()
{
...
void *PairHookeCap::extract(const char *str, int &dim)
{
