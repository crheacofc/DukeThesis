...
def Update_Lammps_Init(Sim_name,LammpsFile,ParticlesInput,Diameter):
    ...
    if len(Domain) == 4: #Rectangle
        DomainSet = 'region		box block '+Domain[0]+' '+Domain[1] + ' '+Domain[2]+' '+Domain[3]' -3 3 units box'
        lines_to_change = [2,29,30,41,47,49]
    else:
        #cirlce
        pass
    new_line_lammps = [DiameterData,InitData,Dump,Restart,Fix1]
