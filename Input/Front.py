...
LammpsFile = 'LAMMPS/inputfiles/in.front'
...
Porosity_Boolean = False
mui = 0.8 #Viscosity of invading Fluid
mud = 0.5 #Viscosity of defending Fluid
Domain = [-0.5,0.5,-0.5,0.5] #Rectangle
#Values for Porosity calculations
annulus_radius = 0.2 #Radius of small anulus
domain_radius = 2.0 #Radius of domain
NN_number = 80 #Number of nearest neighbors
...
def Update_Lammps_Init(Sim_name,LammpsFile,ParticlesInput,Diameter,DomainVals):
    ...
    if len(Domain) == 4: #Rectangle
        ...
        lines_to_change = [2,29,30,41,47,49]
    else:
        #cirlce
        pass
