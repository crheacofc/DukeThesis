...
#ifndef ConstantCoupled_H
#define ConstantCoupled_H
...
class ConstantCoupled : public Kernel
{
public:
   ...
   */
  ConstantCoupled(const InputParameters & parameters);
