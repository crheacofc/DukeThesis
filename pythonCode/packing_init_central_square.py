...
def main():
    ...
    lmp.file('LAMMPS/inputfiles/in.Initialize_Packing_Central_Square')
    #reformat('pos_lammps_out.txt','lammps_circle_100x100_Perturbed_inc.lj',9960)
    for i in range(50):
        reformat('PrimaryFiles/Central_Square/HydroEquil/pos_lammps_out'+str(1000*i)+'.txt','PrimaryFiles/Central_Square/HydroEquil/test'+str(i),9960)
